...
public class UserController {
	...
	public ResponseEntity<UserDTO> applyForJob(@PathVariable Long userId, @PathVariable Long jobId) {
		try {
			UserDTO updatedUser = userService.applyForJob(userId, jobId);
	...
	@GetMapping("/{userId}/appliedJobs")
	public ResponseEntity<List<JobDTO>> getAppliedJobsByUserId(@PathVariable Long userId) {
		try {
			List<JobDTO> appliedJobs = userService.getAppliedJobsByUserId(userId);
